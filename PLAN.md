...
| **C** | Build the public surfaces — homepage, services, browse, audience pages, privacy. Motion, share cards, OG images, designed dark mode. | ~1.5 wk | C1 done (structure accepted, copy defects open); C2 dispatched 2026-08-26. `/for/students` cut — no student scheme in corpus |
