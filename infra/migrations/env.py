...
# Ensure workspace root is in sys.path for importing api modules
...
import api.models.eligibility  # Ensure eligibility models are imported for autogenerate
import api.models.auth  # Ensure auth models are imported for autogenerate
