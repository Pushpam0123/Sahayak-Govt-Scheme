...
def test_split_into_sentences() -> None:
    ...
    assert hindi_sentences[0] == "उम्मीदवार भारत का निवासी होना चाहिए [1]।"
    assert hindi_sentences[1] == "वह कल्याणकारी क्षेत्र से संबंधित होना चाहिए [2]।"
...
def test_parse_citations_for_sentence(caplog: Any) -> None:
    ...
    dup_citations = parse_citations_for_sentence(dup_sentence, max_chunk_index=5)
    assert dup_citations == [1, 2]

    # Out-of-bounds citations (dropped and logged)
    oob_sentence = "Incorrect citation num [6]."
    with caplog.at_level(logging.WARNING):
        oob_citations = parse_citations_for_sentence(oob_sentence, max_chunk_index=5)
