...
# --- Case-insensitivity of categorical rules ---
# Rule values come from government PDFs ("Female", "SC", "Karnataka"); profile
...
def test_genuine_mismatch_still_fails():
    ...
    ok, _ = match_citizen_profile({"state": "Bihar"}, {"states": ["Karnataka"]})
    assert not ok
