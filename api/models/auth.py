...
class User(Base):
    ...
    role: Mapped[str] = mapped_column(String(50), default="citizen", nullable=False)  # citizen, operator, admin
...
class APIKey(Base):
    ...
    prefix: Mapped[str] = mapped_column(String(16), nullable=False)  # e.g. 'shk_live_...'
