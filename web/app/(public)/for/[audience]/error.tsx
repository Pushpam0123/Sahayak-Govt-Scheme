  ...
  return (
    <div className="mx-auto max-w-xl py-16 px-4">
      <Card className="p-8 text-center flex flex-col items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-bold text-content">Unable to load schemes</h1>
          <p className="text-base text-muted mt-2 leading-relaxed">
            We could not connect to the scheme database to retrieve programs for this audience. Please try again.
          </p>
        </div>
