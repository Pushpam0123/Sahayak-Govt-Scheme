...
export default function ForSegmentError({
  reset,
}: {
  ...
  return (
    <div className="mx-auto max-w-xl py-16 px-4">
      <Card className="p-8 text-center flex flex-col items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-bold text-content">Unable to load audience page</h1>
          <p className="text-base text-muted mt-2 leading-relaxed">
            We could not connect to the scheme database. Please try again in a moment.
          </p>
        </div>
